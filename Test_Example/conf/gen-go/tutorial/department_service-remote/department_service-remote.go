...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  string AddDepartment(Department d)")
  fmt.Fprintln(os.Stderr, "  string Put(Department d)")
  fmt.Fprintln(os.Stderr, "  string Delete(string id)")
  fmt.Fprintln(os.Stderr, "   GetUsers(string deid)")
  fmt.Fprintln(os.Stderr, "   GetUsersSame(string userid)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := tutorial.NewDepartmentServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "AddDepartment":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "AddDepartment requires 1 args")
      flag.Usage()
    }
    arg50 := flag.Arg(1)
    ...
    argvalue0 := tutorial.NewDepartment()
    ...
    value0 := argvalue0
    fmt.Print(client.AddDepartment(context.Background(), value0))
    fmt.Print("\n")
    break
  case "Put":
    if flag.NArg() - 1 != 1 {
  ...
  case "GetUsersSame":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetUsersSame requires 1 args")
      flag.Usage()
    }
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.GetUsersSame(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
